          ...
          <div class="grid gap-4 sm:hidden">
            <?php foreach ($contasPagina as $conta): ?>
              <div class="p-4 border border-[var(--color-border)] rounded-lg">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Valor Total: R$ <?= number_format($conta['valor_total'], 2, ',', '.') ?></p>
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Data da Venda: <?= htmlspecialchars($conta['data_venda']) ?></p>
            ...
            <table class="w-full text-left text-sm sm:text-base min-w-[700px]">
              <thead>
                <tr class="border-b border-[var(--color-border)]">
                  ...
                  <th class="p-3 font-semibold text-[var(--color-text-secondary)]">Valor Total</th>
              ...
              <tbody>
                <?php foreach ($contasPagina as $conta): ?>
                  <tr class="border-b border-[var(--color-border)] hover:bg-[var(--color-background)]">
                    ...
                    <td class="p-3 text-[var(--color-text-secondary)]">R$ <?= number_format($conta['valor_total'], 2, ',', '.') ?></td>
                    ...
                    <td class="p-3 text-[var(--color-text-secondary)]"><?= htmlspecialchars($conta['data_venda']) ?></td>
