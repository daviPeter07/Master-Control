<aside id="sidebar"
  ...
  <div class="flex items-center justify-between p-4 border-b border-[var(--color-border)]">
    <a href="../../pages/dashboard/" class="flex items-center space-x-2 overflow-hidden">
  ...
  <nav class="flex-1 overflow-y-auto p-2 space-y-1 text-sm sm:text-base">
    ...
    <a href="../../pages/dashboard/produtos.php"
      class="flex items-center gap-2 py-2 px-2 rounded-md transition-colors font-medium
    ...
    <a href="../../pages/dashboard/clientes.php"
      class="flex items-center gap-2 py-2 px-2 rounded-md transition-colors font-medium
    ...
    <a href="../../pages/dashboard/contas.php"
      class="flex items-center gap-2 py-2 px-2 rounded-md transition-colors font-medium
